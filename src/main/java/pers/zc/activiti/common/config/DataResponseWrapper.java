package pers.zc.activiti.common.config;
...
import pers.zc.activiti.common.util.JsonData;
import pers.zc.activiti.common.util.JsonMapper;

@Aspect
@RestControllerAdvice(value = "pers.zc.activiti")
